...
Select **all deposit groups** and their total deposit sums but **only for the wizards** who have their magic wands **crafted by Ollivander family**. **Filter** total **deposit a**** mounts lower than 150000 **. Order by** total deposit amount **in** descending** order.
